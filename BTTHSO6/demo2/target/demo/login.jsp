...
<body>
 ...
 <div class="container">
     ...
     <form method="post" class="text-center border border-light p-5" action="login">
         ...
         <% if(emailErr!=null){%>
         <p class="text-dager"> <%= emailErr %></p>
    <% } %>

        <%  String passErr = (String) request.getAttribute("pass");%>
         <% if(passErr!=null){%>
             <p class="text-danger"><%= passErr %></p>
        <% } %>
         <% String emailErrs = (String) request.getAttribute("emailErrs"); %>
         <% if(emailErrs!=null){%>
         <p class="text-danger"><%= emailErrs %></p>
         <% } %>
         <% String emailErrss = (String) request.getAttribute("emailErrss"); %>
         <% if(emailErrss!=null){%>
         <p class="text-danger"><%= emailErrss %></p>
         <% } %>
